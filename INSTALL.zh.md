...
2. 官方 Release ZIP：例如 `C:/Users/<your-user-name>/Downloads/AutoStar-v0.3.4-windows-x64.zip`
...
```text
请从这个本地 ZIP 安装 AutoStar：C:/Users/<your-user-name>/Downloads/AutoStar-v0.3.4-windows-x64.zip。
```
...
1. 从官方 GitHub Release 下载 `AutoStar-v0.3.4-windows-x64.zip`。
2. 将 ZIP 解压到临时文件夹。
