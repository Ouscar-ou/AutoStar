...
2. Official Release ZIP, for example `C:/Users/<your-user-name>/Downloads/AutoStar-v0.3.6-windows-x64.zip`
...
```text
Install AutoStar from this local ZIP: C:/Users/<your-user-name>/Downloads/AutoStar-v0.3.6-windows-x64.zip.
```
...
1. Download `AutoStar-v0.3.6-windows-x64.zip` from the official GitHub Release.
