...
欢迎使用 AutoStar，也欢迎围绕 STAR-CCM+ 工作流、螺旋桨 CFD、功能改进、多样化能力的持续拓展与集成，以及实际应用展开交流与共创。

- **问题反馈与功能建议**：[GitHub Issues](https://github.com/Ouscar-ou/AutoStar/issues)<br>
  用于报告 Bug、提交功能建议，以及反馈安装、环境配置和工作流问题。

- **技术讨论与社区共创**：[GitHub Discussions](https://github.com/Ouscar-ou/AutoStar/discussions)<br>
  用于使用经验交流、技术讨论、案例分享、工作流扩展和社区协作。

- **电子邮箱**：<br>
  [seagoou@gmail.com](mailto:seagoou@gmail.com)<br>
  [1664721113@qq.com](mailto:1664721113@qq.com)<br>
  适用于商业合作、项目合作，以及不适合在公开 Issue 中讨论的问题。

- **QQ 交流群**：`1062619533`<br>
  欢迎加入交流群，讨论 AutoStar 使用、STAR-CCM+ 工作流和螺旋桨 CFD 相关问题。

提交问题时，建议提供 AutoStar 版本、STAR-CCM+ 版本、操作系统、使用的网格档位，以及去除敏感信息后的错误日志或报告。请勿公开上传商业机密、许可证信息、私钥或未经授权的几何模型。
